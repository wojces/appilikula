...
function invalidResultPlayerA(level: string): string {
  if (level === "aSixteen" && !props.playerAResultIsValid)
    return "border border-danger";
  else if (level === "quarterFinal" && !props.playerAResultIsValid)
    return "border border-danger";
...
function invalidResultPlayerB(level: string): string {
  if (level === "aSixteen" && !props.playerBResultIsValid)
    return "border border-danger";
  else if (level === "quarterFinal" && !props.playerBResultIsValid)
    return "border border-danger";
